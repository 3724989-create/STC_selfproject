...
//// 接入 DL1B 模块
////      模块管脚            单片机管脚
////      SCL                 查看 zf_device_dl1b.h 中 DL1B_SCL_PIN  宏定义 默认 P16
////      SDA                 查看 zf_device_dl1b.h 中 DL1B_SDA_PIN  宏定义 默认 P14
////      XS                  查看 zf_device_dl1b.h 中 DL1B_XS_PIN   宏定义 默认 不接
////      VCC                 5V 电源
////      GND                 电源地
...
//// 1.核心板烧录完成本例程
////
//// 2.在断电情况下，单独使用 type-c接口 或者 USB-TTL 模块，在断电情况下完成连接，并连接好 DL1B 模块
////      ( 如果使用配套的学习主板测试，则直接将 DL1B 模块接到对应的接口位置 )
////
//// 3.将 type-c接口 或者 USB-TTL 模块连接电脑，完成上电
