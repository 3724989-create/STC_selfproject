...
//
// 2.将 type-c接口 或者 USB-TTL 模块连接 电脑，完成上电
//
...
#define ADC_CHANNEL1            (ADC_CH0_P10 )
#define ADC_CHANNEL2            (ADC_CH9_P01 )
#define ADC_CHANNEL3            (ADC_CH13_P05)
#define ADC_CHANNEL4            (ADC_CH14_P06)
