...
#define		PWM4P_OUT_EN()	PWMA_ENO |= 0x40	/* 使能 PWM4P 输出 */
#define		PWM4P_OUT_DIS()	PWMA_ENO &= ~0x40	/* 禁止 PWM4P 输出 */
#define		PWM4N_OUT_EN()	PWMA_ENO |= 0x80	/* 使能 PWM4N 输出 */
#define		PWM4N_OUT_DIS()	PWMA_ENO &= ~0x80	/* 禁止 PWM4N 输出 */
...
#ifdef  AI8051U_32Bit	//8051U系列 管脚对应如下配置
...
#define		PWM2_USE_P12P13()		PWMA_PS = (PWMA_PS & ~0x0C)			/* PWM 通道 2 输出脚切换到P12(PWM2P) P13(PWM2N) */
...
#define		PWMA5_USE_P33()		    PWMA_P2S = (PWMA_P2S & ~0x03)		    /* 高级PWMA 通道 5 输出脚切换到P33(PWM4) */
#define		PWMA5_USE_P44()		    PWMA_P2S = (PWMA_P2S & ~0x03) | 0x01	/* 高级PWMA 通道 5 输出脚切换到P44(PWM4) */
#define		PWMA5_USE_P56()		    PWMA_P2S = (PWMA_P2S & ~0x03) | 0x02	/* 高级PWMA 通道 5 输出脚切换到P56(PWM4) */

#define		PWMA6_USE_P34()		    PWMA_P2S = (PWMA_P2S & ~0x0C)		    /* 高级PWMA 通道 6 输出脚切换到P34(PWM4) */
#define		PWMA6_USE_P47()		    PWMA_P2S = (PWMA_P2S & ~0x0C) | 0x04	/* 高级PWMA 通道 6 输出脚切换到P47(PWM4) */
#define		PWMA6_USE_P57()		    PWMA_P2S = (PWMA_P2S & ~0x0C) | 0x08	/* 高级PWMA 通道 6 输出脚切换到P57(PWM4) */
...
#define		PWM6_USE_P03()			PWMB_PS = (PWMB_PS & ~0x0C)			/* PWM 通道 6 输出脚切换到P03(PWM6) */
#define		PWM6_USE_P13()			PWMB_PS = (PWMB_PS & ~0x0C) | 0x04	/* PWM 通道 6 输出脚切换到P13(PWM6) */
#define		PWM6_USE_P23()			PWMB_PS = (PWMB_PS & ~0x0C) | 0x08	/* PWM 通道 6 输出脚切换到P23(PWM6) */
#define		PWM6_USE_P51()			PWMB_PS = (PWMB_PS | 0x0C)			/* PWM 通道 6 输出脚切换到P51(PWM6) */
...
#define		PWM8_USE_P27()			PWMB_PS = (PWMB_PS & ~0xC0) | 0x80	/* PWM 通道 8 输出脚切换到P03(PWM8) */
...
#define ENO1P       0x01            //选择输出通道  PWM1 P
#define ENO1N       0x02            //选择输出通道  PWM1 N
#define ENO2P       0x04            //选择输出通道  PWM2 P
#define ENO2N       0x08            //选择输出通道  PWM2 N
#define ENO3P       0x10            //选择输出通道  PWM3 P
#define ENO3N       0x20            //选择输出通道  PWM3 N
#define ENO4P       0x40            //选择输出通道  PWM4 P
#define ENO4N       0x80            //选择输出通道  PWM4 N

/*此处未补充8051U的 高级PWMA通道5，6的选择配置，感兴趣的自行研究*/

#define ENO5P       0x01            //选择输出通道  PWM5 P
#define ENO6P       0x04            //选择输出通道  PWM6 P
#define ENO7P       0x10            //选择输出通道  PWM7 P
#define ENO8P       0x40            //选择输出通道  PWM8 P
...
void UpdatePwmCh(u8 PWM_CH, u16 Duty);
